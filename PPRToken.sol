...
contract PPRToken is
    BaseToken("Pi Pet Rescue", "PPR", 100000000000 * 10**18, 18),
    SafeToken
{
    using SafeMath for uint256;

    // Special wallets
    address public lpAddress = 0xc0265FD142A1B61d19655F99693493C0Ff45b327;
    address public marketingAddress =
        0x4615eF35f707a3b8EE5fd260f5689DcCcf102Be9;
    address public charityAddress = 0x0b02e20a99d7cB7C4C41E83F9003f9e036CbEA7A;
    ...
    uint8 public BUY_IN_TAX_PERCENTAGE = 5;
    uint8 public SELL_OUT_TAX_PERCENTAGE = 5;
    ...
    */
    ...
    function swapBackAndDistributeBuyTax() private swapping {
        // Distributed Token
        _basicTransfer(address(this), lpAddress, undistributedBuyTax.mul(40).div(100));
        _basicTransfer(address(this), charityAddress, undistributedBuyTax.mul(40).div(100));
        _basicTransfer(address(this), marketingAddress, undistributedBuyTax.mul(20).div(100));
    ...
    function swapBackAndDistributeSellTax() private swapping {
        // Distributed Token
        _basicTransfer(address(this), lpAddress, undistributedSellTax.mul(40).div(100));
        _basicTransfer(address(this), charityAddress, undistributedSellTax.mul(40).div(100));
        _basicTransfer(address(this), marketingAddress, undistributedSellTax.mul(20).div(100));
